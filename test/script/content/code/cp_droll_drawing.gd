...
@export var py: int=256:
	set(value):
		...
		if prev_value!=value:
			py_changed.emit(py)
# Starting brush size
@export var brush_size_start: float=0.5# brush size start
...
# Brush
@export_file var brush_path: String="res://addons/scribbler/icons/scribbler_brush.png"# must be square!
...
#func get_texture()->ImageTexture:## REMOVED CF CONSECRATED
	#return texture
